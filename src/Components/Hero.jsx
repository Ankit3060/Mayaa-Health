...
return (
  ...
  24/7 doctor consults, mental health support, annual checkups, and <br /> accident insurance — all in one
  affordable plan.
</p>
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 sm:gap-4 mb-4 sm:mb-6">
            <img src={Collage} alt="Trusted users" className="w-16 sm:w-20 md:w-28 h-auto rounded-full" />
