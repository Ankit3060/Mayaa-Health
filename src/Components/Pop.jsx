    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1">
          <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
        ...
        <div className="flex justify-center md:justify-end flex-1">
          <button
            ...
            className="bg-[#073B4C] hover:bg-[#05505C] transition text-white font-bold py-3 px-8 rounded-full shadow-md text-base sm:text-lg md:text-xl cursor-pointer"
          >
            Book a Free Call
          </button>
        </div>
